...
namespace EC.UI.Mvc.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> VerifyCode(string provider, string returnUrl, string userId)
        {
            ...
            return System.Web.UI.WebControls.View(new VerifyCodeViewModel { Provider = provider, ReturnUrl = returnUrl, UserId = userId });
        }
        ...
        public async Task<ActionResult> SendCode(string returnUrl)
        {
            ...
            return System.Web.UI.WebControls.View(new SendCodeViewModel { Providers = factorOptions, ReturnUrl = returnUrl, UserId = userId });
        }
